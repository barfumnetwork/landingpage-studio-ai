...
def main() -> None:
    ...
    views = [
        ...
        ("side-34", Vector((2.10, -0.35, 0.30)), 0.64, (1440, 900)),
        ("fly-34", Vector((0.95, -1.65, 0.70)), 0.64, (1440, 900)),
        ("wings", Vector((0.08, -0.40, 2.20)), 0.62, (1440, 900)),
        ("1440", Vector((1.05, -1.75, 0.50)), 0.64, (1440, 900)),
        ("390", Vector((0.55, -1.85, 0.25)), 0.62, (390, 844)),
        ("430", Vector((0.55, -1.85, 0.25)), 0.62, (430, 932)),
        ("mobile-crop", Vector((0.40, -1.70, 0.18)), 0.66, (390, 844)),
    ]
